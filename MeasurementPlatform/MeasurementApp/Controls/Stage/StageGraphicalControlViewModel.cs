...
public class StageGraphicalControlViewModel: ObservableObject
{
    ...
    public StageGraphicalControlViewModel(IServiceProvider serviceProvider, ILogger<StageGraphicalControlViewModel> logger)
    {
        ...
        _systemController = _service.GetService(typeof(SystemController)) as SystemController ?? throw new Exception("SystemController is null");
        _stageConfig = _service.GetService(typeof(StageConfig)) as StageConfig ?? throw new Exception("StageConfig is null");
